...
public class ShrinePagodaBlock extends Block implements IWaterLoggable {
	...
	protected static final VoxelShape TOP 		= Block.box(0.0D, 0.0D, 0.0D, 16.0D, 5.0D, 16.0D);
	protected static final VoxelShape BOTTOM	= Block.box(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	...
	public VoxelShape getShape(BlockState state, IBlockReader reader, BlockPos pos, ISelectionContext context) {
		...
		case LOWER: default: return BOTTOM;
		}
	}
