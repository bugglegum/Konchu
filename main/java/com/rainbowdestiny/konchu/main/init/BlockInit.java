...
public class BlockInit {
    ...
    //Crab Block
    public static final RegistryObject<Block> CRAB_BLOCK = KonchuRegistry.BLOCKS.register("crab_block", () -> new BlockBase(Block.Properties.of(Material.STONE).harvestLevel(1).strength(25F, 1200F).sound(SoundType.NETHERRACK)));
