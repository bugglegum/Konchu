...
import com.rainbowdestiny.konchu.common.items.MagnifierItem;
...
public class KonchuItems {
    ...
    public static final RegistryObject<Item> STRIPPED_DRIFT_LOG_ITEM 	= KonchuRegistry.ITEMS.register("stripped_drift_log", 	() -> new BlockItemBase(KonchuBlocks.STRIPPED_DRIFT_LOG.get(), 	ItemGroup.TAB_BUILDING_BLOCKS));
    public static final RegistryObject<Item> STRIPPED_DRIFT_WOOD_ITEM 	= KonchuRegistry.ITEMS.register("stripped_drift_wood", 	() -> new BlockItemBase(KonchuBlocks.STRIPPED_DRIFT_WOOD.get(), ItemGroup.TAB_BUILDING_BLOCKS));
    ...
    public static final RegistryObject<Item> STRIPPED_INFESTED_DRIFT_LOG_ITEM 	= KonchuRegistry.ITEMS.register("stripped_infested_drift_log", 	() -> new BlockItemBase(KonchuBlocks.STRIPPED_INFESTED_DRIFT_LOG.get(), 	ItemGroup.TAB_BUILDING_BLOCKS));
    public static final RegistryObject<Item> STRIPPED_INFESTED_DRIFT_WOOD_ITEM	= KonchuRegistry.ITEMS.register("stripped_infested_drift_wood", () -> new BlockItemBase(KonchuBlocks.STRIPPED_INFESTED_DRIFT_WOOD.get(), 	ItemGroup.TAB_BUILDING_BLOCKS));
    ...
    public static final RegistryObject<Item> INFESTED_DRIFT_WOOD_ITEM 			= KonchuRegistry.ITEMS.register("infested_drift_wood", 			() -> new BlockItemBase(KonchuBlocks.INFESTED_DRIFT_WOOD.get(), 			ItemGroup.TAB_BUILDING_BLOCKS));
    
    /* Spawn Items */
    public static final RegistryObject<Item> SNAIL_SPAWN_EGG	= KonchuRegistry.ITEMS.register("snail_spawn_egg", 	() -> new KonchuSpawnEggItem(KonchuEntityType.SNAIL, 10581318, 12693373, (new Item.Properties()).tab(ItemGroup.TAB_MISC)));
    public static final RegistryObject<Item> FROG_SPAWN_EGG		= KonchuRegistry.ITEMS.register("frog_spawn_egg", 	() -> new KonchuSpawnEggItem(KonchuEntityType.FROG,   7844695, 16776620, (new Item.Properties()).tab(ItemGroup.TAB_MISC)));
}
