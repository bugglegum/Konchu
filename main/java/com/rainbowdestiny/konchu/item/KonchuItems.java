...
public class KonchuItems {
    ...
    public static final RegistryObject<Item> WHITE_CHERRY_LEAVES 				= KonchuRegistry.ITEMS.register("white_cherry_leaves",			() -> new ProxyBlockItem(KonchuBlocks.WHITE_CHERRY_LEAVES.get(), 			ItemGroup.TAB_DECORATIONS));
    public static final RegistryObject<Item> PINK_CHERRY_LEAVES 				= KonchuRegistry.ITEMS.register("pink_cherry_leaves",			() -> new ProxyBlockItem(KonchuBlocks.PINK_CHERRY_LEAVES.get(), 			ItemGroup.TAB_DECORATIONS));
    public static final RegistryObject<Item> MAGENTA_CHERRY_LEAVES 				= KonchuRegistry.ITEMS.register("magenta_cherry_leaves",		() -> new ProxyBlockItem(KonchuBlocks.MAGENTA_CHERRY_LEAVES.get(), 			ItemGroup.TAB_DECORATIONS));
