...
public class GardenSnailModel extends AnimatedGeoModel<GardenSnailEntity> {
    private static final ResourceLocation DefaultSnail = {
	...
	protected static final ResourceLocation DEFAULT = DefaultSnail;
    protected static final ResourceLocation BROWN_GARDEN_SNAIL = new ResourceLocation(Konchu.MOD_ID, "textures/entity/snail/brown_garden_snail.png");
    protected static final ResourceLocation GREEN_GARDEN_SNAIL = new ResourceLocation(Konchu.MOD_ID, "textures/entity/snail/green_garden_snail.png");
    protected static final ResourceLocation GRAY_GARDEN_SNAIL = new ResourceLocation(Konchu.MOD_ID, "textures/entity/snail/gray_garden_snail.png");
    protected static final ResourceLocation GOLDEN_GARDEN_SNAIL = new ResourceLocation(Konchu.MOD_ID, "textures/entity/snail/golden_garden_snail.png");
    };
